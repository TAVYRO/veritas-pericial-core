      ...
      <main className="p-6 space-y-6">
        ...
        <div className="space-y-6">
          {ongoingCases.map((c) => (
            <Card
              key={c.id}
              className="bg-veritas-graphite/40 border-white/5 overflow-hidden veritas-card group cursor-pointer"
            >
              <CardContent className="p-0">
                <div className="p-5 space-y-4">
                  <div className="flex justify-between items-start">
                    <div className="space-y-1">
                      <span className="text-[10px] font-mono text-veritas-silver/40 uppercase tracking-tighter">
                        {c.process}
                      </span>
                      <h4 className="text-lg font-bold text-white group-hover:text-veritas-electric transition-colors">
                        {c.title}
                      </h4>
                    </div>
                    <Badge
                      variant="outline"
                      className="bg-veritas-electric/10 text-veritas-electric border-veritas-electric/20 text-[10px]"
                    >
                      {c.progress}%
                    </Badge>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-y-3 gap-x-4">
                    <div className="space-y-1">
                      <span className="text-[9px] uppercase tracking-widest text-veritas-silver/40 font-bold">
                        Modalidade
                      </span>
                  ...
                  {c.pendencies > 0 && (
                    <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-3 flex items-center gap-3">
                      ...
                      <span className="text-xs text-amber-500/80 font-medium">
                        {c.pendencies} pendências críticas aguardando ação
                      </span>
                    </div>
                  )}
