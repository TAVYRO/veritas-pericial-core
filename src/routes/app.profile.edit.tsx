  ...
  return (
    <div className="min-h-[100dvh] veritas-hero-gradient pb-[calc(6rem+env(safe-area-inset-bottom))] text-white relative">
      <header className={cn(
        ...
        <Button size="sm" className="bg-veritas-electric hover:bg-veritas-electric-glow gap-2 font-bold rounded-xl">
      ...
      <main className="p-6 space-y-6">
        <div className="space-y-4">
          <div className="space-y-2">
            <Label className="text-white/40 uppercase tracking-widest text-[10px] font-bold">Nome Profissional</Label>
            <Input defaultValue="Dra. Mônica Hazama" className="bg-white/5 border-white/10" />
          </div>
          <div className="space-y-2">
            <Label className="text-white/40 uppercase tracking-widest text-[10px] font-bold">Especialidade</Label>
            <Input defaultValue="Psicóloga Perita" className="bg-white/5 border-white/10" />
          </div>
          <div className="space-y-2">
            <Label className="text-white/40 uppercase tracking-widest text-[10px] font-bold">Registro Profissional</Label>
            <Input defaultValue="CRP 00/00000" className="bg-white/5 border-white/10" />
          </div>
          <div className="space-y-2">
            <Label className="text-white/40 uppercase tracking-widest text-[10px] font-bold">Região de Atuação</Label>
            <Input defaultValue="Curitiba - PR" className="bg-white/5 border-white/10" />
          </div>
          <div className="space-y-2">
            <Label className="text-white/40 uppercase tracking-widest text-[10px] font-bold">E-mail</Label>
            <Input defaultValue="monica.hazama@veritas.app" className="bg-white/5 border-white/10" />
          </div>
        </div>
      </main>
    </div>
