        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-white/40 text-[10px] uppercase tracking-widest font-bold">
              Estruturas documentais disponíveis
            </p>
          </div>
        </div>
      </header>
      ...
      <main className="p-6 space-y-8 relative">
        {generalTemplates.length > 0 && (
          <section className="space-y-4">
            <h2 className="text-xs font-bold text-veritas-electric uppercase tracking-widest px-1">
              Geral
            </h2>
        ...
        {multiprofessionalTemplates.length > 0 && (
          <section className="space-y-4">
            <h2 className="text-xs font-bold text-veritas-violet uppercase tracking-widest px-1">
              Multiprofissional
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
