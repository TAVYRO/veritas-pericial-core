...
const OFFICIAL_QUESTIONS = [
  {
    ...
    response:
      "Não foram identificados riscos imediatos à integridade física ou psicológica. Recomenda-se, contudo, a transição assistida para fortalecer o vínculo paterno-filial.",
  },
  {
    id: "Q2",
    ...
    response:
      "Observa-se dinâmica de alta conflitualidade e triangulação, porém os elementos colhidos até o momento são insuficientes para uma afirmação conclusiva de alienação parental estruturada.",
  },
  {
    id: "Q3",
              ...
              {q.response ? (
                ...
                <div className="bg-red-500/5 border border-red-500/10 p-4 rounded-xl flex items-center gap-3">
                  ...
                  <p className="text-xs text-red-400 font-medium italic">
                    Sem elementos técnicos suficientes para resposta conclusiva.
                  </p>
                </div>
              )}
            </div>
