...
import { FileText, Plus, Upload, Users, Scale, ArrowLeft } from "lucide-react";
      ...
      <main className="p-6 space-y-6">
        ...
        <div className="grid gap-4">
          {sections.map((section) => (
            <Card
              key={section.title}
              className="bg-veritas-graphite/40 border-white/5 hover:border-white/10 transition-all group cursor-pointer"
            >
              <CardContent className="p-5 flex items-center justify-between">
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="text-veritas-silver/20 group-hover:text-veritas-electric transition-colors"
                >
        ...
        <div className="pt-8">
          <Button
            ...
            onClick={() =>
              navigate({ to: "/app/review/$reviewId/check", params: { reviewId: "demo-review" } })
            }
          >
            Iniciar Verificação
          </Button>
