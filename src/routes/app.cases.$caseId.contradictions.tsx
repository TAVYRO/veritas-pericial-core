...
const CONTRADICTIONS = [
  {
    ...
    limit: "Impossível determinar o horário real sem registros externos (ex: mensagens ou portaria)."
  },
  {
  ...
  return (
    <div className="p-6 space-y-6 pb-24">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold tracking-tight text-white">Contradições e Convergências</h2>
                ...
                {c.items.map((item, i) => (
                  <div key={i} className="bg-white/5 rounded-xl p-3 border-l-2 border-white/10">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[9px] font-bold text-veritas-electric uppercase tracking-widest">{item.type}</span>
              ...
              <div className="grid gap-3 pt-2">
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-[9px] font-bold text-emerald-400 uppercase tracking-widest mb-0.5">Convergência</p>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-[9px] font-bold text-rose-400 uppercase tracking-widest mb-0.5">Divergência</p>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-[9px] font-bold text-amber-400 uppercase tracking-widest mb-0.5">Limite de Análise</p>
      ...
      <div className="p-4 bg-veritas-violet/5 border border-veritas-violet/10 rounded-xl">
        <div className="flex gap-3">
          ...
          <p className="text-[10px] text-veritas-violet/80 leading-relaxed font-medium">
            A Veritas organiza os relatos e identifica as tensões discursivas. A decisão sobre a veracidade ou a interpretação final dos fatos é de exclusiva responsabilidade da profissional.
          </p>
        </div>
      </div>
    </div>
