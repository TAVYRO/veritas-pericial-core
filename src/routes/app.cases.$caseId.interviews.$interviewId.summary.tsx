      ...
      <div className="p-6 space-y-6">
        ...
        <section className="space-y-3">
          <div className="flex items-center gap-2 text-veritas-violet">
            ...
            <h3 className="text-[10px] font-bold uppercase tracking-widest">Observações Técnicas</h3>
          </div>
          <div className="bg-white/5 border border-white/5 rounded-2xl p-4 space-y-3">
            <p className="text-xs text-white/70 leading-relaxed italic">
              Entrevistada demonstrou leve hesitação ao mencionar o horário de retorno das visitas (00:03:15).
            </p>
            <p className="text-xs text-white/70 leading-relaxed italic">
              Manutenção de contato visual adequado e discurso coerente durante a maior parte da sessão.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            {["Rede de Apoio", "Rotina Escolar", "Impacto das Visitas", "Vínculo Materno"].map(tema => (
              <span key={tema} className="px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-full text-[10px] font-medium">
                {tema}
              </span>
            ))}
          </div>
        ...
        <section className="space-y-3">
          <div className="flex items-center gap-2 text-amber-400">
            ...
            <h3 className="text-[10px] font-bold uppercase tracking-widest">Quesitos Relacionados</h3>
          </div>
        ...
        <section className="space-y-3">
          <div className="flex items-center gap-2 text-rose-400">
            ...
            <h3 className="text-[10px] font-bold uppercase tracking-widest">Limites da Informação</h3>
          </div>
          <div className="bg-rose-500/5 border border-rose-500/10 rounded-2xl p-4">
            <p className="text-xs text-white/60 leading-relaxed">
              O horário exato de retorno das visitas não foi precisado devido a ruído no áudio e imprecisão da entrevistada. Necessário confrontar com relato do genitor.
            </p>
          </div>
        </section>
      </div>
