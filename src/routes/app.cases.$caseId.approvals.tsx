...
import { Activity, CheckCircle2, Lock, ShieldCheck, Signature } from "lucide-react";
    ...
    <div className="p-6 space-y-6 pb-32">
      <header className="space-y-4">
        ...
        <p className="text-xs text-white/40 leading-relaxed">
          Para liberar a emissão do documento final, todos os pilares de segurança e conformidade
