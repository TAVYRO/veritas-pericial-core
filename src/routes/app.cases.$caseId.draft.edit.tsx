...
import { ChevronLeft, Save, MessageSquare, Eye, Edit3, Check, X, RefreshCw, Search } from "lucide-react";
    ...
    <div className="flex flex-col h-screen bg-veritas-ink">
      <header className="sticky top-0 z-50 bg-veritas-graphite border-b border-white/5 p-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-sm font-bold text-white tracking-tight uppercase tracking-widest">Editor de Relatório</h2>
        </div>
           ...
           <div className="max-w-3xl mx-auto space-y-6">
             <div className="bg-white/5 border border-white/10 p-6 rounded-xl space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-bold text-white/40 uppercase tracking-widest">Seção: Metodologia</span>
                  <div className="flex gap-2">
                    <button className="p-1.5 hover:bg-white/10 rounded text-white/40"><MessageSquare className="w-4 h-4" /></button>
                    <button className="p-1.5 hover:bg-white/10 rounded text-white/40"><Search className="w-4 h-4" /></button>
                  </div>
                </div>
                <textarea 
             ...
             <div className="bg-veritas-electric/5 border border-veritas-electric/20 p-6 rounded-xl space-y-4 animate-fade-in-up">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 text-veritas-electric">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest">✨ Sugestão Veritas</span>
                  </div>
                  <div className="flex gap-2">
                ...
                <p className="text-sm text-white/90 leading-relaxed font-medium">
                  "O padrão interacional observado sugere uma dinâmica familiar polarizada, na qual a criança é exposta a conteúdos depreciativos acerca da figura paterna, o que compromete a neutralidade técnica e o bem-estar psicológico do menor."
                </p>
             </div>
           </div>
        </div>
