...
import { ArrowLeft, Eye, EyeOff, Check, X, Shield, User, Mail, Phone, Lock } from "lucide-react";
        ...
        <form onSubmit={handleSubmit} className="space-y-5 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="space-y-1.5">
            ...
            {formData.password.length > 0 && (
              <div className="space-y-2 px-1 py-1 animate-in fade-in slide-in-from-top-1">
          ...
          <div className="space-y-1.5">
            ...
            {formData.confirmPassword.length > 0 && formData.password !== formData.confirmPassword && (
              <p className="text-[10px] text-red-400/80 ml-1 animate-in fade-in">As senhas não coincidem</p>
            )}
          </div>

          <Button 
            type="submit" 
            className="w-full h-12 bg-veritas-electric hover:bg-veritas-electric-glow text-veritas-ink font-bold text-base shadow-[0_0_20px_-5px_rgba(101,217,255,0.4)] hover:shadow-[0_0_25px_-2px_rgba(101,217,255,0.5)] transition-all active:scale-[0.98] rounded-xl mt-4"
          >
            Continuar
          </Button>
        </form>
