            ...
            <div key={idx} className="bg-white/5 border border-white/5 rounded-2xl p-4 space-y-3 relative group">
              <div className="flex items-center justify-between">
                <div className={`flex items-center gap-2 ${note.color}`}>
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest">{note.type}</span>
                </div>
              ...
              <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                <button className="text-[10px] text-white/40 hover:text-white uppercase tracking-widest font-bold">Editar</button>
                <button className="text-[10px] text-rose-500/60 hover:text-rose-500 uppercase tracking-widest font-bold">Excluir</button>
              </div>
            </div>
          );
        })}
