    ...
    <div className="min-h-[100dvh] veritas-hero-gradient pb-[calc(6rem+env(safe-area-inset-bottom))] text-white relative">
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <p className="text-[10px] text-veritas-silver/40 uppercase tracking-widest font-mono">
            ID: {reviewId}
          </p>
        </div>
      </header>
      ...
      <main className="p-6 space-y-6">
        <div className="bg-white/5 border border-white/5 rounded-2xl p-4 flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm font-bold text-veritas-silver">
              Analisando 14 dimensões técnicas...
            </p>
          </div>
          ...
          {items.map((item) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-bold text-veritas-silver group-hover:text-white transition-colors">
                  {item.label}
                </span>
              </div>
