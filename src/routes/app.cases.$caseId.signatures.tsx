...
function SignaturesPage() {
  ...
  const { getCase, getWorkflow, authorizeSignature, revokeSignature, isSignatureApproved } =
    useCaseWorkflow();
      ...
      <div className="bg-amber-500/5 border border-amber-500/20 p-4 rounded-2xl flex items-start gap-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-amber-500/60 leading-relaxed">
            Assinatura digitalizada não constitui certificado digital ICP-Brasil. Para validade
            jurídica plena em processos eletrônicos, o arquivo exportado deverá ser assinado
            individualmente pelo profissional via portal do Tribunal ou assinador certificado.
          </p>
        </div>
      </div>
    </div>
